...
CHORES = {
    ...
    steps: {
      ...
      add_broth: {
        actions: [
          ...
          { action: :update, executor: proc { |actor| actor.carrying = :broth } },
          ...
          { action: :update, executor: proc { |actor| actor.carrying, $state.stove.carrying = nil, :pot_of_soup } },
        ],
      },
      add_veg: {
        actions: [
          ...
          { action: :update, executor: proc { |actor| actor.carrying = :whole_hard_veg } },
          { action: :move, x: 174, y: 600, facing: :n },
          { action: :wait, animation: :washing, duration: 2.seconds },
          { action: :update, executor: proc { |actor| actor.carrying = :cut_hard_veg } },
          { action: :move, x: 244, y: 600, facing: :n },
          { action: :activate, interactive: :stove, state: :stovetop },
          { action: :wait, animation: :washing, duration: 1.seconds },
          { action: :update, executor: proc { |actor| actor.carrying, $state.stove.carrying = nil, :pot_of_soup } },
      ...
      add_meat: {
        actions: [
          ...
          { action: :wait, animation: :washing, duration: 30 },
          { action: :activate, interactive: :fridge, state: :default },
          { action: :update, executor: proc { |actor| actor.carrying = :whole_meat } },
          { action: :move, x: 174, y: 600, facing: :n },
          { action: :wait, animation: :washing, duration: 2.seconds },
          { action: :update, executor: proc { |actor| actor.carrying = :cut_meat } },
          { action: :move, x: 244, y: 600, facing: :n },
          { action: :activate, interactive: :stove, state: :stovetop },
          { action: :wait, animation: :washing, duration: 1.seconds },
          { action: :update, executor: proc { |actor| actor.carrying, $state.stove.carrying = nil, :pot_of_soup } },
      ...
      add_roots: {
        actions: [
          ...
          { action: :update, executor: proc { |actor| actor.carrying = :whole_root_veg } },
          { action: :move, x: 174, y: 600, facing: :n },
          { action: :wait, animation: :washing, duration: 2.seconds },
          { action: :update, executor: proc { |actor| actor.carrying = :cut_root_veg } },
          { action: :move, x: 244, y: 600, facing: :n },
          { action: :activate, interactive: :stove, state: :stovetop },
          { action: :wait, animation: :washing, duration: 1.seconds },
          { action: :update, executor: proc { |actor| actor.carrying, $state.stove.carrying = nil, :pot_of_soup } },
    ...
    steps: {
      add_veg: {
        actions: [
          ...
          { action: :activate, interactive: :fridge, state: :fridge },
          { action: :wait, animation: :washing, duration: 30 },
          { action: :update, executor: proc { |actor| actor.carrying = :whole_soft_veg } },
          { action: :activate, interactive: :fridge, state: :default },
          { action: :move, x: 174, y: 600, facing: :n },
          { action: :wait, animation: :washing, duration: 2.seconds },
          { action: :update, executor: proc { |actor| actor.carrying = :cut_soft_veg } },
          { action: :move, x: 244, y: 600, facing: :n },
    ...
    steps: {
      gather_flour: {
        actions: [
          ...
          { action: :update, executor: proc { |actor| actor.carrying = :flour } },
      ...
      gather_water: {
        actions: [
          ...
          { action: :update, executor: proc { |actor| actor.carrying = :water } },
          { action: :move, x: 300, y: 600, facing: :n },
          { action: :update, executor: proc { |actor| actor.carrying = nil } },
          { action: :wait, animation: :washing, duration: 20 },
        ]
      ...
      gather_yeast: {
        actions: [
          ...
          { action: :activate, interactive: :fridge, state: :fridge },
          { action: :wait, animation: :washing, duration: 20 },
          { action: :update, executor: proc { |actor| actor.carrying = :yeast } },
          { action: :activate, interactive: :fridge, state: :default },
          { action: :move, x: 300, y: 600, facing: :n },
          { action: :update, executor: proc { |actor| actor.carrying = nil } },
          { action: :wait, animation: :washing, duration: 10 },
  ...
  baking_bread: {
    ...
    steps: {
      ...
      finalize: {
        actions: [
          { action: :update, executor: proc { |actor| actor.carrying = :dough } },
          { action: :move, x: 240, y: 600, facing: :n },
    ...
    steps: {
      ...
      loading_1: {
        actions: [
          { action: :move, x: 106, y: 548, facing: :w },
          { action: :wait, animation: :washing, duration: 20 },
          { action: :update, executor: proc { |actor| actor.carrying = :dish } },
